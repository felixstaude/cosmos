export const PLANETS = [
  ...
  {
    name: 'Ferria', type: 'Metallic World', color: [0.7, 0.65, 0.6],
    radius: 1.3, orbitRadius: 130, orbitSpeed: 0.04, rotationSpeed: 0.014,
    tilt: 0.12, moons: 1, hasRings: false,
    atmoColor: [0.6, 0.45, 0.3],
    stats: {
      mass: '2.8 M\u2295', radius: '1.15 R\u2295', temp: '420 K',
      gravity: '2.1 g', day: '18.4 h', year: '5.2 yr',
      atmosphere: 'Trace Fe vapor, CO\u2082', pressure: '0.02 atm'
    },
    desc: 'A hyper-dense iron world with a surface of polished metal plains and rust-red oxide canyons. Its powerful magnetic field traps stellar wind into shimmering auroral curtains. Ancient tectonic stresses have exposed veins of pure nickel-iron that gleam like mirrors under starlight.'
  },
  {
    name: 'Luminara', type: 'Crystal World', color: [0.8, 0.85, 0.95],
    radius: 1.0, orbitRadius: 145, orbitSpeed: 0.035, rotationSpeed: 0.01,
    tilt: 0.08, moons: 0, hasRings: false,
    atmoColor: [0.6, 0.7, 1.0],
    stats: {
      mass: '0.6 M\u2295', radius: '0.82 R\u2295', temp: '145 K',
      gravity: '0.72 g', day: '42.1 h', year: '6.8 yr',
      atmosphere: 'N\u2082, Ar', pressure: '0.3 atm'
    },
    desc: 'A world of towering crystalline spires and vast faceted plains formed under extreme pressure. Silicate and quartz megastructures refract light into dazzling prismatic rainbows. The thin atmosphere scatters short wavelengths, bathing the surface in an ethereal blue-violet glow.'
  }
];
